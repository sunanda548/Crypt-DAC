  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <td><input id="email" name="email" class="text"/></td>
	   ...
	   <tr>
	  <td height="39" bgcolor="#FF0000"><span class="style1">
	  ...
	  <td><input id="mobile" name="mobile" class="text"/></td>
	   ...
	   <tr>
	  <td height="116" bgcolor="#FF0000"><span class="style1">
	  ...
	  <td><textarea id="address" name="address" rows="6" cols="25"></textarea></td>
	   ...
	   <tr>
	  <td height="44" bgcolor="#FF0000"><span class="style1">
	  ...
	  <td><select id="s1" name="gender" class="text">
	   ...
	   <tr>
	  <td height="55" bgcolor="#FF0000"><span class="style1">
	  ...
	  <td><input id="pin" name="pin" class="text"/></td>
	   ...
	   <tr>
	  <td height="34" bgcolor="#FF0000"><span class="style1">
	  ...
	  <tr>
	  <td height="63" bgcolor="#FF0000"><span class="style1">
