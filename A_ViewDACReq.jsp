  ...
  <div class="content">
    <div class="content_resize">
        <div class="article">
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <h2>View <span class="style3"> User DAC Request</span> & Permit </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
<%
  ...
  <tr>
	...
	{
	%>
	 <td><div align="center" class="style17"><a href="A_DACauthorize_Read.jsp?id=<%=i%>&uname=<%=s22%>&status=<%=s55%>"> <%=s55%></a></div></td>
	<%}
	else
	{%>
	...
	{
	%>
	 <td><div align="center" class="style17"><a href="A_DACauthorize_Write.jsp?id=<%=i%>&uname=<%=s22%>&status=<%=s66%>"> <%=s66%></a></div></td>
	<%}
	else
	{%>
...
%>
                ...
                <p>&nbsp;</p>
                <p><a href="AdminMain.jsp">Go Back</a>          </p>
                <div class="clr"></div>
        </div>
